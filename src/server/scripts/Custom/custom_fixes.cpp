...
public:
    ...
    class spell_fumping_39238SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnEffect += SpellEffectFn(spell_fumping_39238SpellScript::HandleDummy, EFFECT_ALL, SPELL_EFFECT_ANY);
        }
    };
...
public:
    ...
    class spell_fumping_39246SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnEffect += SpellEffectFn(spell_fumping_39246SpellScript::HandleDummy, EFFECT_ALL, SPELL_EFFECT_ANY);
        }
    };
...
public:
    ...
    struct npc_evergrove_druidAI : public ScriptedAI
    {
        ...
        void MovementInform(uint32 type, uint32 id)
        {
            ...
            me->SetPosition( x, y, z, 0.0f, true);
            if(!player->IsFlying())
            {
