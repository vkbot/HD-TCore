...
public:
    ...
    class spell_sunreaver_disguise_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnEffect += SpellEffectFn(spell_sunreaver_disguise_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
        }
    };
...
public:
    ...
    class spell_silvert_convenant_disguise_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnEffect += SpellEffectFn(spell_silvert_convenant_disguise_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
        }
    };
